...
const Header = () => {
  ...
  const CustomLink = ({ href, children, ...props }) => {
    return (
      <Link to={href} {...props} className={path === href ? 'active nav-link' : 'nav-link'}>
        {children}
      </Link>
    );
  };
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <CustomLink href="/myOrders">Mina Orders</CustomLink>
            </li>
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <CustomLink className="dropdown-item" href="/profile">
                    Profil
                  </CustomLink>
                </li>
                <li>
                  <CustomLink className="dropdown-item" href="/create">
                    Skapa artikel
                  </CustomLink>
                </li>
                <li>
                  <CustomLink className="dropdown-item" href="/farmOrders">
                    Mina Artiklar
                  </CustomLink>
                </li>
              </ul>
